...
public abstract class CFGEdge implements Comparable<CFGEdge> {
   ...
   static public CFGEdge makeEdge(final CFGNode<?> fromNode, final CFGNode<?> toNode, boolean control) {
      ...
      assert fromNode instanceof CFGControlNode || fromNode instanceof CFGPseudoNode : "\"fromNode\" is neither CFGControlNode nor CFGPseudoNode.";
   ...
   static public CFGEdge makeEdge(final CFGNode<?> fromNode, final CFGNode<?> toNode) {
      ...
      else if (fromNode instanceof CFGBreakStatementNode || fromNode instanceof CFGContinueStatementNode) {
   ...
   public boolean equals(final Object arg) {
      if (this.getClass().equals(arg.getClass())) {
         ...
         return this.fromNode.equals(edge.fromNode) && this.toNode.equals(edge.toNode);
      }
      else {
         return false;
      }
