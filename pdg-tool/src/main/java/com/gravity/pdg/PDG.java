...
public class PDG implements Comparable<PDG> {
   ...
   public PDG(final MethodInfo unit, final PDGNodeFactory pdgNodeFactory, final CFGNodeFactory cfgNodeFactory, final boolean buildControlDependence,
      final boolean buildDataDependence, final boolean buildExecutionDependence, final int controlDependencyDistance,
      final int dataDependencyDistance, final int executionDependencyDistance) {
   ...
   public PDG(final MethodInfo unit, final PDGNodeFactory pdgNodeFactory, final CFGNodeFactory cfgNodeFactory, final boolean buildControlDependency,
      final boolean buildDataDependency, final boolean buildExecutionDependency) {

      this(unit, pdgNodeFactory, cfgNodeFactory, buildControlDependency, buildDataDependency, buildExecutionDependency, Integer.MAX_VALUE,
         Integer.MAX_VALUE, Integer.MAX_VALUE);
   }

   public PDG(final MethodInfo unit, final PDGNodeFactory pdgNodeFactory, final CFGNodeFactory cfgNodeFactory) {
   ...
   public PDG(final MethodInfo unit, final boolean buildControlDependency, final boolean buildDataDependencey,
      final boolean buildExecutionDependency) {
      this(unit, new PDGNodeFactory(), new CFGNodeFactory(), buildControlDependency, buildDataDependencey, buildExecutionDependency);
   }
   ...
   private void getAllNodes(final PDGNode<?> node, final SortedSet<PDGNode<?>> nodes) {
   ...
   public void build() {
      ...
      if (this.buildControlDependence) {
         ...
         for (final PDGParameterNode parameterNode : this.parameterNodes) {
            final PDGControlDependenceEdge edge = new PDGControlDependenceEdge(this.enterNode, parameterNode, true);
      ...
      if (this.buildDataDependence) {
         for (final PDGParameterNode parameterNode : this.parameterNodes) {
            if (!this.cfg.isEmpty()) {
               this.buildDataDependence(this.cfg.getEnterNode(), parameterNode, parameterNode.core.name, new HashSet<CFGNode<?>>());
            }
         }
      }
   ...
   private void buildDataDependence(final CFGNode<?> cfgNode, final PDGNode<?> fromPDGNode, final String variable,
   ...
   private void buildControlDependence(final PDGControlNode fromPDGNode, final StatementInfo statement, final boolean type) {
