...
public class ClonePairInfo {
   ...
   ClonePairInfo(final CodeFragmentInfo left, final CodeFragmentInfo right, final int type) {
      this.left = left;
      this.right = right;
      this.type = type;
   }
   ...
   static public List<ClonePairInfo> getClonepairs(final File file, final int minimum, final boolean oracle) {
      ...
      try {
         ...
         while (reader.ready()) {
            ...
            final ClonePairInfo pair = ClonePairInfo.getClonepair(line, oracle);
   ...
   static private ClonePairInfo getClonepair(final String line, final boolean oracle) {
      ...
      final CodeFragmentInfo leftFragment = new CodeFragmentInfo(leftPath, Integer.parseInt(leftStartLine), Integer.parseInt(leftEndLine));
      final CodeFragmentInfo rightFragment = new CodeFragmentInfo(rightPath, Integer.parseInt(rightStartLine), Integer.parseInt(rightEndLine));
