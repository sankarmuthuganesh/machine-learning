...
public class Intertwined {
   ...
   public static void main(final String[] args) {
      ...
      if (2 != args.length) {
         ...
         System.err.println("the second one is a file for storing intertwined clones.");
         System.exit(0);
      }
      ...
      final List<ClonePairInfo> clonepairs = ClonePairInfo.getClonepairs(new File(input), 6, false);
