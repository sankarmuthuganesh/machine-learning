...
public class NormalizedText {
   ...
   public static String normalize(final String text) {
      ...
      while (true) {
         ...
         final String target = normalizedText.substring(startIndex, endIndex + 1);
   ...
   private void generateText() {
      ...
      if (this.core instanceof StatementInfo) {
         ...
         switch (core.getCategory()) {
            case Assert: {
               text.append("assert ");
               final ProgramElementInfo expression = core.getExpressions().get(0);
               final NormalizedText expressionText = new NormalizedText(expression);
            ...
            case Case: {
               if (0 < core.getExpressions().size()) {
                  text.append("case ");
                  final ProgramElementInfo label = core.getExpressions().get(0);
            ...
            case Throw: {
               text.append("throw ");
               final ProgramElementInfo expression = ((StatementInfo) this.core).getExpressions().get(0);
               final NormalizedText expressionText = new NormalizedText(expression);
               text.append(expressionText.getText());
               text.append(";");
               break;
            ...
            case TypeDeclaration: {
               final ClassInfo typeDeclaration = (ClassInfo) ((StatementInfo) this.core).getExpressions().get(0);
               text.append("class ");
            ...
            case VariableDeclaration: {
               final List<ProgramElementInfo> expressions = ((StatementInfo) this.core).getExpressions();
               final NormalizedText typeText = new NormalizedText(expressions.get(0));
               ...
               for (int i = 1; i < expressions.size(); i++) {
                  anyExpression = true;
                  final NormalizedText fragmentText = new NormalizedText(expressions.get(i));
         ...
         switch (((ExpressionInfo) this.core).category) {
            case ArrayAccess: {
               final ProgramElementInfo expression = coreExp.getExpressions().get(0);
               final NormalizedText expressionText = new NormalizedText(expression);
               text.append(expressionText.getText());
               text.append("[");
               final ProgramElementInfo index = coreExp.getExpressions().get(1);
            ...
            case ArrayCreation: {
               ...
               if (1 < coreExp.getExpressions().size()) {
                  final ProgramElementInfo initializer = coreExp.getExpressions().get(1);
                  final NormalizedText initializerText = new NormalizedText(initializer);
            ...
            case ArrayInitializer: {
               text.append("{");
               for (final ProgramElementInfo expression : coreExp.getExpressions()) {
                  final NormalizedText expressionText = new NormalizedText(expression);
                  text.append(expressionText.getText());
                  text.append(",");
               }
            ...
            case Assignment: {
               ...
               text.append(" ");
               final ProgramElementInfo operator = coreExp.getExpressions().get(1);
               final NormalizedText operatorText = new NormalizedText(operator);
               text.append(operatorText.getText());
               text.append(" ");
               final ProgramElementInfo right = coreExp.getExpressions().get(2);
            ...
            case Cast: {
               ...
               text.append(typeText.getText());
               text.append(")");
               final ProgramElementInfo expression = coreExp.getExpressions().get(1);
               final NormalizedText expressionText = new NormalizedText(expression);
               text.append(expressionText.getText());
               break;
            }
            ...
            case ClassInstanceCreation: {
               ...
               text.append(type.getText());
               text.append("(");
               final List<ProgramElementInfo> expressions = coreExp.getExpressions();
               expressions.remove(0);
               for (final ProgramElementInfo argument : expressions) {
                  final NormalizedText argumentText = new NormalizedText(argument);
            ...
            case ConstructorInvocation: {
               ...
               for (final ProgramElementInfo argument : coreExp.getExpressions()) {
                  final NormalizedText argumentText = new NormalizedText(argument);
                  text.append(argumentText.getText());
                  text.append(",");
               }
            ...
            case Instanceof: {
               ...
               final ProgramElementInfo right = coreExp.getExpressions().get(1);
            ...
            case MethodInvocation: {
               if (null != coreExp.getQualifier()) {
                  ...
                  final NormalizedText qualifierText = new NormalizedText(qualifier);
            ...
            case Postfix: {
               final ProgramElementInfo operand = coreExp.getExpressions().get(0);
            ...
            case Prefix: {
               final ProgramElementInfo operator = coreExp.getExpressions().get(0);
               final NormalizedText operatorText = new NormalizedText(operator);
               text.append(operatorText.getText());

               final ProgramElementInfo operand = coreExp.getExpressions().get(1);
               final NormalizedText operandText = new NormalizedText(operand);
               text.append(operandText.getText());
               break;
            }
            ...
            case Trinomial: {
               ...
               final ProgramElementInfo thenExp = coreExp.getExpressions().get(1);
               final NormalizedText thenExpText = new NormalizedText(thenExp);
               text.append(thenExpText.getText());

               text.append(": ");

               final ProgramElementInfo elseExp = coreExp.getExpressions().get(2);
            ...
            case VariableDeclarationExpression: {
               ...
               text.append(" ");
               final NormalizedText expressionText = new NormalizedText(expressions.get(1));
               text.append(expressionText.getText());
               break;
            }
