package com.gravity.scorpio.data;
...
public class ClonePairInfo implements Comparable<ClonePairInfo> {
   ...
   public int compareTo(final ClonePairInfo clonepair) {
      ...
      final int leftOrder = this.getLeftCodeFragment().compareTo(clonepair.getLeftCodeFragment());
      if (0 != leftOrder) {
         return leftOrder;
      }

      final int rightOrder = this.getRightCodeFragment().compareTo(clonepair.getRightCodeFragment());
      if (0 != rightOrder) {
         return rightOrder;
      }
   ...
   public boolean conflict(final ClonePairInfo clonepair) {
      ...
      return this.getLeftCodeFragment().conflict(clonepair.getLeftCodeFragment())
