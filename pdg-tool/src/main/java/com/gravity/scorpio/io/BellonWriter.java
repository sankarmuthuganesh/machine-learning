...
public class BellonWriter extends Writer {
   ...
   public BellonWriter(final String path, final SortedSet<ClonePairInfo> clonepairs) {
   ...
   public void write() {
      ...
      try {
         ...
         for (final ClonePairInfo clonepair : this.clonepairs) {
            ...
            final SortedSet<ProgramElementInfo> elementsA = new TreeSet<ProgramElementInfo>(new LocationalComparator());
            final SortedSet<ProgramElementInfo> elementsB = new TreeSet<ProgramElementInfo>(new LocationalComparator());
   ...
   class LocationalComparator implements Comparator<ProgramElementInfo> {
      ...
      @Override
      public int compare(final ProgramElementInfo o1, final ProgramElementInfo o2) {
